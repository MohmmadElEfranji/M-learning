...
import com.nerds.m_learning.databinding.CellAllCoursesListBinding
import com.nerds.m_learning.teacher.model.Teachers

class AllCoursesAdapter(var context: Context) :
    RecyclerView.Adapter<AllCoursesAdapter.ItemViewHolder>() {
    ...
    /*----------------------------------*/
    private var courseList: MutableList<Teachers.Courses> = ArrayList()

    fun setCoursesList(list: MutableList<Teachers.Courses>) {
        courseList = list
    ...
    class ItemViewHolder(val binding: CellAllCoursesListBinding) :
        RecyclerView.ViewHolder(binding.root)


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding = CellAllCoursesListBinding.inflate(
     ...
     */
    private fun toggleIcon(binding: CellAllCoursesListBinding, position: Int) {
        if (selectedItems!![position, false]) {
